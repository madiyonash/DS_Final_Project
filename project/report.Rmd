...
It is also interesting to note the mood scale: from here, we see that the mean mood for me overall in 2019 was 3.743/5. Not a bad number!


## Univariate Data Analysis
First, let's see how my feelings stacked up by visualizing the distribution of my moods.
```{r}
report_2019 %>% 
  ggplot() +
